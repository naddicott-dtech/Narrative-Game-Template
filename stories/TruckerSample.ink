...
// A readable sample resource-management game written in Ink.
//
// Student note:
...
Dispatch has one coast-to-coast run available. Your tractor is fueled, your logbook is open, and New York is a long way east.

First, choose the cargo you will haul.
...
You back under a refrigerated trailer loaded with California avocados.
...
You back under a sealed trailer packed with cell phones.
...
The warehouse doors roll shut behind you. Morning traffic crawls across the basin, and the long ribbon of interstate points east.
...
The city haze is gone. Sunlight flashes off windshields, dry mountains crowd the horizon, and the desert offers very little shade.
...
Casino towers glow beside the highway even in daylight. Delivery vans, tour buses, and impatient commuters squeeze around your rig.
...
You cross the high desert under an enormous sky. Red cliffs and long grades replace the lights of Nevada.
...
The Sandia Mountains rise beyond the city. A sign directs commercial trucks toward an open inspection station.

-> inspection

= inspection

The inspector checks your lights, tires, and paperwork. Everything passes, but the inspection costs one hour.
...
The road stretches across the Texas Panhandle. Wind shoves at the side of the trailer, and tumbleweeds skip across the shoulder.
...
Dark clouds pile up ahead of you. Rain drums on the cab while traffic slows beneath the highway interchanges.
...
Fields roll past in every direction. Grain elevators and water towers mark towns too small to appear on your route sheet.
...
The Gateway Arch appears through the windshield. Brake lights stack up near the Mississippi River crossings.
...
The Appalachian grades make the engine work. The East Coast is close now, but steep roads and dense traffic still stand between you and the receiver.
...
You park in a legal space, close the curtains, and sleep for eight hours.
...
You pull up to the diesel pumps. Filling both tanks takes one hour.
...
You merge onto the highway and settle in for the next leg.
...
{event_roll <= police_risk:
    Red and blue lights appear in your mirror. A highway patrol officer pulls you onto the shoulder.

    "I clocked you at {speed_over} over," the officer says.

    ~ violations = violations + 1
    ~ elapsed_hours = elapsed_hours + 2

    The ticket and roadside stop cost two hours.
...
{
- event_roll <= 12:
    A crash ahead closes one lane. Stop-and-go traffic costs two hours.
    ~ elapsed_hours = elapsed_hours + 2
- event_roll <= 24:
...
The skyline rises ahead. After one final crawl through city traffic, you back into the receiver's loading dock.
...
You delivered the avocados from Los Angeles to New York.
...
You completed the cell-phone run from Los Angeles to New York.
...
The truck leaves the lane. The run ends on the shoulder in twisted metal and flashing emergency lights.
